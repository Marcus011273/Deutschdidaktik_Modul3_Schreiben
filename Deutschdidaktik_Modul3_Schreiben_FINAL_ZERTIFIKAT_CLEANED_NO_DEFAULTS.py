FRAGENPOOL = [
    {
        ...
        "antwort": "Förderung sportlicher Aktivität",
        "gewichtung": 1
    },
    {
        "id": "m3_2",
    ...
    },
    {
        "id": "m3_3",
        "typ": "szenario",
        "frage": "Ein Schüler schreibt einen Text mit wenig Struktur und ohne klares Ziel. Was sollte laut LehrplanPLUS gezielt gefördert werden?",
        "optionen": [
            "Handgeschicklichkeit",
            "Textüberarbeitung mit Textlupe",
    ...
    },
    {
        "id": "m3_4",
        "typ": "multi_select",
        "frage": "Welche Elemente gehören laut Präsentation zur expliziten Schreibstrategie-Vermittlung?",
        "optionen": [
            "Cluster",
            "Mindmap",
    ...
    },
    {
        "id": "m3_5",
        "typ": "offen",
        "frage": "Warum ist der Begriff 'Aufsatz' laut Präsentation nicht mehr zeitgemäß?",
        "gewichtung": 2
    },
    {
        "id": "m3_6",
        "typ": "single_choice",
        "frage": "Welcher Aspekt gehört nicht zur Definition guter Schreibaufgaben?",
        "optionen": [
            "Konkreter Adressat",
            "Unmittelbarer Alltagsbezug",
            "Mündliche Kommunikation als Ziel",
            "Schreibziel bewusst machen"
        ],
        "antwort": "Mündliche Kommunikation als Ziel",
        "gewichtung": 1
    },
    {
        "id": "m3_7",
        "typ": "szenario",
        "frage": "Eine Schülerin nutzt beim Schreiben W-Fragen, Cluster und Mindmaps. Welche Phase wird hier angesprochen?",
        "optionen": [
            "Überarbeitung",
            "Planung",
            "Bewertung",
    ...
    },
    {
        "id": "m3_8",
        "typ": "szenario",
        "frage": "Eine Klasse hat ihre ersten Textentwürfe verfasst. Die Lehrkraft gibt gezielte Hinweise zu Satzbau, Wortwahl und Textstruktur. In welcher Phase des Schreibprozesses befinden sich die Schülerinnen und Schüler?",
        "optionen": [
            "Planung",
            "Überarbeitung",
            "Schreibfluss",
        ...
        "antwort": "Überarbeitung",
        "gewichtung": 1
    },
    {
        "id": "m3_9",
        "typ": "zuordnung",
        "frage": "Ordne den Aussagen jeweils die passende Qualität guter Schreibaufgaben zu:",
        "paare": [
            [
            ...
            [
                "Die Aufgabe geht von realitätsnahen Situationen aus.",
                [
                    "Alltagsbezug",
                    "Zielklarheit",
                    "Adressatenbezug"
            ...
            [
                "Die Schülerinnen und Schüler sollen den Leser kennen.",
                [
                    "Adressatenbezug",
                    "Alltagsbezug",
                    "Zielklarheit"
    ...
    },
    {
        "id": "m3_11",
        "typ": "multi_select",
        "frage": "Welche Aussagen treffen auf einen vollständigen Schreibprozess im Unterricht zu?",
        "optionen": [
            "Schreiben beginnt erst, wenn der Text fertig ist",
            "Reflexion gehört zum Schreiben",
            "Überarbeitung erfolgt idealerweise mehrstufig",
    ...
    },
    {
        "id": "m3_12",
        "typ": "single_choice",
        "frage": "Welche Aussage beschreibt laut Präsentation die Rolle der Lehrkraft im Schreibunterricht am besten?",
        "optionen": [
            "Die Lehrkraft bewertet vor allem Rechtschreibung",
            "Die Lehrkraft ist Coach im Schreibprozess",
            "Die Lehrkraft bleibt während des Schreibens passiv",
            "Die Lehrkraft schreibt die Texte für die Schüler vor"
        ],
    ...
    },
    {
        "id": "m3_14",
        "typ": "offen",
        "frage": "Wie können Schreibaufgaben gestaltet sein, damit sie unterschiedliche Lernvoraussetzungen berücksichtigen?",
        "gewichtung": 2
    }
]
...
# === KONFIGURATION ===
st.set_page_config(page_title="Interaktiver Test – Modul 3", page_icon="📝")
st.title("📝 Interaktiver Test zu Modul 3: Schreiben")
...
class ZertifikatPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "für besondere Leistungen im Kompetenzbereich Schreiben", ln=True, align='C')
        self.ln(10)
    ...
    if seite >= len(fragenliste):
        ...
        if not antwort_bestaetigt:
            if frage["typ"] == "single_choice":
                ...
                auswahl = st.multiselect("Wähle alle zutreffenden Optionen:", frage["optionen"], default=[], key=f"{key_base}_multi")
                if st.button("Antwort bestätigen", key=f"btn_{key_base}"):
